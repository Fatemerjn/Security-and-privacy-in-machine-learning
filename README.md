...
This implementation accompanies coursework in Security and Privacy in Machine Learning, covering:
- **Homework 3**: Membership Inference Attacks and Defenses
- **Homework 4**: Model Extraction and Data Poisoning
- **Homework 5**: Differential Privacy Mechanisms
...
- Tramèr, F., et al. "Stealing Machine Learning Models via Prediction APIs" (2016)
- Shokri, R., et al. "Membership Inference Attacks against Machine Learning Models" (2017)
...
**Fateme Rajabinasab**
- GitHub: [@Fatemerjn](https://github.com/Fatemerjn)
